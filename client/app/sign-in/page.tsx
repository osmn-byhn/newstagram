      ...
      <div className="container mt-40">
        <h1 className="text-2xl font-bold text-center my-12">Sign-in Next Blog</h1>
            <form className="flex flex-col gap-2">
                ...
                <button type="submit" className="bg-slate-800 text-white px-4 py-2 mt-12 rounded-md">Sign-in</button>
                <Link href="/login"  className="bg-[rgba('0,0,0,0')] text-black px-4 py-2 mt-1 rounded-md text-center">Login</Link>
            </form>
      </div>
    </div>
  )
